---
title: "The Heroes of Java: Çağatay Çivici"
...
Staying strong, the "<a href="http://blog.eisele.net/2011/09/heroes-of-java.html">Heroes of Java</a>" series reaches the 18th edition. This time it is about Çağatay Çivici who is the inventor and lead developer of my favorite JSF component library Primefaces.
<br>
<br><b>Çağatay Çivici</b>
<br>
<div class="separator" style="clear: both; text-align: center;">
 <a href="cagataycivici.jpg" imageanchor="1" style="clear: right; float: right; margin-bottom: 1em; margin-left: 1em;"><img border="0" height="320" src="cagataycivici.jpg" width="210"></a>
</div> is a member of JavaServer Faces Expert Group, the founder and project lead of popular PrimeFaces Component Suite and PMC member of open source JSF implementation Apache MyFaces. He’s a recognized speaker in international conferences such as JavaOne, SpringOne, JAX, Jazoon, Confess, JSFSummit and many local events such as JUGs. Cagatay is also an author and technical reviewer of couple of books regarding web application development with Java and JSF. As an experienced trainer, he has trained over 300 developers on Java EE technologies mainly JSF, Spring, EJB 3.x and JPA. Cagatay is currently working as a consultant, mentor and instructor for Prime Teknoloji in Turkey.
<br>
<br><b>General Part</b>
<br><i>Who are you?</i>
<br>
...
<br>
 Main reason is PR for work [<a href="" target="_blank">@cagataycivici</a>]. Most of my tweets are about PrimeFaces, well, @primefaces also has an official account but I tweet things that can be considered as "under the hood" activity.
<br>
