---
title: "SANS Institute TOP 25 Most Dangerous Programming Errors"
...
On January 12, 2009 the SANS Institute released a combined list of the <a href="" target="_blank">25 most dangerous programming errors</a>. Experts from more than 30 US and international cyber security organizations jointly released the consensus list.
<br>
<br>
...
<br>
<br>
Until now, most guidance focused on the 'vulnerabilities' that result from programming errors. This is helpful. <a href="" target="_blank">The Top 25</a>, however, focuses on the actual programming errors, made by developers that create the vulnerabilities. As important, <a href="" target="_blank">the Top 25 web site</a> provides detailed and authoritative information on mitigation.
<br>
<br>
